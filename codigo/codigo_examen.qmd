...
df %>%
  ...
  ggplot(aes(x = grupo_edad, y = n, fill = INDICADOR_MOROSO)) +
    ...
    coord_flip() +
    scale_fill_manual(values = c("SI" = "pink", "NO" = "lightblue")) +
    labs(title = "Piramide poblacional de EDAD segun morosidad",
...
df %>%
  ...
  ggplot(aes(x = grupo_salario, y = n, fill = INDICADOR_MOROSO)) +
    ...
    coord_flip() +
    scale_fill_manual(values = c("SI" = "pink", "NO" = "lightblue")) +
    labs(title = "Piramide poblacional de SALARIO segun morosidad (escala log)",
         x = "Grupo de salario", y = "Frecuencia (log)") +
    theme_minimal()
